...
class ViewModel {
    ...
    constructor() {
        ...
        this._url = ko.pureComputed( () => {
            ...
            +`&filter=store_date:${this._currentWeek().start}|${this._currentWeek().end}`
    ...
    pageHandler(data) {
        ...
        if ( this._totalPageResults > this._pageResults ) {
            ...
            let pagesNum = Math.ceil( this._totalPageResults/this._pageResults );
